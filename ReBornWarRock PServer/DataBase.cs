...
namespace ReBornWarRock_PServer
{
    public static class DB
    {
        ...
        public static bool openConnection(string dbHost, int dbPort, string dbName, string dbUsername, string dbPassword)
        {
            try
            {
                //Log.AppendText("Connecting to " + dbName + " at " + dbHost + ":" + dbPort + " for user '" + dbUsername + "'");
                ...
                dbConnection.StateChange += new System.Data.StateChangeEventHandler(dbConnection_StateChange);
                dbConnection.Open();
                //Log.AppendText("Connection to database successfull.");
                return true;
            }
        ...
        public static void closeConnection()
        {
            ...
            catch { Log.AppendText("No database connection."); }
        }
        #endregion
        ...
        public static void runQuery(string Query)
        {
            ...
            catch (Exception ex) { Log.AppendText("Error '" + ex.Message + "' at '" + Query + "'"); }
        }
        #endregion
